...
const ManagerSidebar = (props) => {
	...
	return (
		...
		>
			{isDesktop && <Menu className="w-[256px] h-[calc(100vh-70px)] fixed" selectedKeys={localStorage.getItem("sidebar_item")} mode="inline" items={items} />}
			{isTablet && (
				<>
					<div
						className={`absolute w-[256px] z-40 top-0 flex justify-end p-4 transition-all
